...
export const Footer = () => {
  ...
  return (
    <footer className="bg-navy text-white relative overflow-hidden">
        ...
        <div className="py-16 lg:py-20">
          <div className="grid lg:grid-cols-4 gap-12 lg:gap-16">
            ...
            <div>
              ...
              <ul className="space-y-4">
                {[
                  ...
                  <li key={link.label}>
                    <a href={link.href} className="text-white/70 hover:text-primary transition-colors duration-300">{link.label}</a>
                  </li>
                ))}
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-4">
                {["Facebook", "Instagram", "LinkedIn", "WhatsApp"].map((name) => (
                  <li key={name}>
                    <a href="#" className="text-white/70 hover:text-primary transition-colors duration-300">{name}</a>
                  </li>
                ))}
              </ul>
            </div>
          ...
          <div className="border-t border-white/10 pt-12 mt-12">
            <div className="max-w-2xl mx-auto text-center">
              ...
              <p className="text-white/70 mb-6">Receba as últimas atualizações sobre novos serviços e funcionalidades.</p>
      ...
      <motion.button
        onClick={scrollToTop}
        className="fixed bottom-8 right-8 w-12 h-12 bg-primary text-white rounded-xl shadow-large hover:shadow-xl z-50"
        whileHover={{ scale: 1.1 }}
        whileTap={{ scale: 0.9 }}
